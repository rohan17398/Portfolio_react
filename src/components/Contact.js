    ...
    <section className="my-28 px-5" id="contact">
      <div className="md:mx-6 flex flex-col flex-wrap md:flex-row justify-between">
        <div className="md:w-6/12 md:px-0 p-5 my-5">
          ...
          <div>
            <p className="font-bold text-base">Rohan Baldha</p>
            <p className="font-thin text-base">San Fransisco Bay Area, California</p>
            <a
              href="mailto: baldharohan@gmail.com"
              className=" mt-3 inline-block border-gray-500 text-sm"
            >
              baldharohan@gmail.com
            </a>
          </div>
          ...
          <div className="flex flex-row flex-wrap mt-7">
            <div className="mr-4">
              <a
                href="https://www.linkedin.com/in/rohan-baldha-169235139/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="mr-4">
              <a
                href="https://twitter.com/Rohanb17"
                target="_blank"
                rel="noreferrer"
              >
                <span className="mb-2 flex flex-row items-end border border-gray-500 p-2 rounded-lg text-sm">
          ...
          <a href="./Rohan_Baldha_Resume.pdf" download>
            <button
              type="submit"
        ...
        <div className="bg-gray px-5 md:py-8 sm:p-8 my-2 md:rounded-lg shadow-lg  justify-between w-full h-content  md:w-6/12 ">
          <form
            ...
            name="contact"
            method="post"
            action="mailto:baldharohan@gmail.com"
